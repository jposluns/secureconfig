...
files=(
  ...
  admin-uis.md observability-components.md devops-uis.md cors.md headers.md firebase-supabase.md supabase-self-hosted.md web-exposure.md realtime-webhooks.md transactional-email-posture.md bi-dashboards.md low-code-builders.md server-admin-panels.md pocketbase.md headless-browser-services.md headless-cms-instant-api.md exposure-index.md common-mistakes.md
)
