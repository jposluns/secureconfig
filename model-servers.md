...
- vLLM server host default (`FrontendArgs.host` defaults to `None`; the launcher binds `(args.host or "", port)`, i.e. all interfaces, and logs `0.0.0.0`; checked 2026-09-14): https://github.com/vllm-project/vllm/blob/main/vllm/entrypoints/launchers/cli_args.py
