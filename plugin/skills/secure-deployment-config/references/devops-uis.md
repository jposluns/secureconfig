...
if ! docker exec gitlab true 2>/dev/null; then
  echo 'cannot reach a container named gitlab: fix the name or start it, this is not a result'
elif docker exec gitlab test -f /etc/gitlab/initial_root_password; then
