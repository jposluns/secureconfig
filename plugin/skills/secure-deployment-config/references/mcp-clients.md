...
- RFC 9700 section 4.2, section 4.2.4, and section 4.4.2, OAuth 2.0 Security Best Current Practice (credential leak channels; referrer suppression and single-use `state`; mix-up attacks): https://www.rfc-editor.org/rfc/rfc9700.html#section-4.2.4
