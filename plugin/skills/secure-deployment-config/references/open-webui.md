      ...
      case "$2" in
        ...
        UPLOAD)
          curl -q -g -sS --noproxy '*' --connect-timeout 5 --max-time 60 \
            ...
            -w 'http=%{http_code} exit=%{exitcode} err=%{errormsg}\n' "$1"
          ;;
        *) echo "use GET, POST or UPLOAD; not probing"; exit 1 ;;
      esac
      ;;
...
This row carries the original probes and the new controls together. Configuration inspection alone does not close it.
