...
- Official Redis Docker images (redis/docker-library-redis): the build patch that sets the `protected-mode` default to 0, and `CMD ["redis-server"]`, present in every Dockerfile on the default branch at commit 584feaab6cd12a77866c121beff1bb16ff239486 (6.2 through 7.4; the patch is shown for 7.4 Debian and Alpine, 7.2 and 6.2) and at release tag v8.10.2: https://github.com/redis/docker-library-redis/blob/584feaab6cd12a77866c121beff1bb16ff239486/7.4/debian/Dockerfile#L85-L90, https://github.com/redis/docker-library-redis/blob/584feaab6cd12a77866c121beff1bb16ff239486/7.4/debian/Dockerfile#L146-L150, https://github.com/redis/docker-library-redis/blob/584feaab6cd12a77866c121beff1bb16ff239486/7.4/alpine/Dockerfile#L79-L84, https://github.com/redis/docker-library-redis/blob/584feaab6cd12a77866c121beff1bb16ff239486/7.2/debian/Dockerfile#L85-L90, https://github.com/redis/docker-library-redis/blob/584feaab6cd12a77866c121beff1bb16ff239486/6.2/debian/Dockerfile#L85-L90, https://github.com/redis/docker-library-redis/blob/v8.10.2/debian/Dockerfile#L70-L75, https://github.com/redis/docker-library-redis/blob/v8.10.2/debian/Dockerfile#L127-L130, https://github.com/redis/docker-library-redis/blob/v8.10.2/alpine/Dockerfile#L82-L87, https://github.com/redis/docker-library-redis/blob/v8.10.2/alpine/Dockerfile#L142-L145; the entrypoints (every one at the pinned commit, and 8.10.2 Debian and Alpine) do not supply a configuration file or set bind, protected-mode or password: https://github.com/redis/docker-library-redis/blob/584feaab6cd12a77866c121beff1bb16ff239486/7.4/debian/docker-entrypoint.sh, https://github.com/redis/docker-library-redis/blob/584feaab6cd12a77866c121beff1bb16ff239486/7.4/alpine/docker-entrypoint.sh, https://github.com/redis/docker-library-redis/blob/v8.10.2/debian/docker-entrypoint.sh and https://github.com/redis/docker-library-redis/blob/v8.10.2/alpine/docker-entrypoint.sh
