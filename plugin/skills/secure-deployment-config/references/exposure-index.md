...
| 19529 | Milvus proxy internal gRPC (v3.0.2 and v2.6.24), on every interface | No credentials checked; `authorizationEnabled` applies only on the external 19530 | [vector-databases.md](vector-databases.md) |
