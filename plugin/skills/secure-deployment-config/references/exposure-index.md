...
| 10000/UDP | Webmin's server discovery socket (`listen=10000`), on every IPv4 address | A listener that sits outside the login, so other servers can find this one | [server-admin-panels.md](server-admin-panels.md) |
...
| 20000/UDP | Usermin's server discovery socket (`listen=20000`), on every IPv4 address | A listener that sits outside the login, so other servers can find this one | [server-admin-panels.md](server-admin-panels.md) |
