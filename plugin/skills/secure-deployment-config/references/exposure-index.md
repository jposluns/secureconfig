...
| 5671, 5672 | AMQP over TLS, and AMQP plaintext | `guest`/`guest`, usable only from localhost, except in the official Docker image, which sets `loopback_users.guest = false` | [rabbitmq.md](rabbitmq.md) |
...
| 15671 | RabbitMQ management UI over TLS, as noted in the guide's listener inventory | `guest`/`guest`, usable only from localhost, except in the official Docker image, which sets `loopback_users.guest = false` | [rabbitmq.md](rabbitmq.md) |
| 15672 | RabbitMQ management UI | `guest`/`guest`, usable only from localhost, except in the official Docker image, which sets `loopback_users.guest = false` | [rabbitmq.md](rabbitmq.md) |
