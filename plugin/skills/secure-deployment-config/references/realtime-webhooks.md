...
- OWASP Authorization, MFA, and Secrets Management Cheat Sheets: https://cheatsheetseries.owasp.org/cheatsheets/Authorization_Cheat_Sheet.html
- Proxy timeouts: Traefik v3.5 entryPoints, Caddy server timeouts, nginx `proxy_read_timeout`: https://doc.traefik.io/traefik/v3.5/reference/install-configuration/entrypoints/
