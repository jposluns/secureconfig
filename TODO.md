...
## Priority 1: Fix and deepen existing guides

Findings from the 2026-09-13 coverage audit, one row per guide. Three families read the corpus
independently; codex and claude read all 85 guides, gemini read 16. A row tagged `[N families]`
was raised independently by that many, which is corroboration rather than a louder opinion.
