...
| 25 | SMTP relay or MX; the exposure to index is an open relay, not the port itself; also Windmill's email triggers, which its Compose file publishes on 25 | not stated | [transactional-email-posture.md](transactional-email-posture.md), [low-code-builders.md](low-code-builders.md) |
