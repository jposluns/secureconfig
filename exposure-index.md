...
| 9300 to 9400 | Elasticsearch transport default range (the official images set `network.host: 0.0.0.0`, so transport listens on all interfaces); authentik's unauthenticated Prometheus metrics on 9300 | varies by service; see the guides | [elasticsearch.md](elasticsearch.md), [self-hosted-idp.md](self-hosted-idp.md) |
