...
| 7947 | Weaviate's internal cluster API, on every local address | Treat it as unauthenticated and open it only to cluster peers | [vector-databases.md](vector-databases.md) |
