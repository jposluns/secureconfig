...
| 9883 | Mosquitto 2.1's HTTP API and web dashboard (`protocol http_api`), which the official 2.1 images enable on every address | The official 2.1 images allow it without credentials (`allow_anonymous true`, no password file or ACL); the 2.1.2 manual recommends binding it to loopback behind an authenticating reverse proxy | [mosquitto.md](mosquitto.md) |
